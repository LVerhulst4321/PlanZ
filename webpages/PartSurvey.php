				...
				if ($obj->typename != "heading") {
                    ...
                    switch ($obj->typename) {
                        ...
                        default:
                            ...
                            //echo "shortname = '" . $obj->shortname . "', questionid = " . $obj->questionid . ", id = '" . $obj->id . "', post = '" . $_POST[$obj->id] . "'<br/>";
                            //var_dump($_POST);
                            $ans = isset($_POST[$obj->id]) ? $_POST[$obj->id] : null;
                            $parms= array($badgeid, $obj->questionid, $privacyuser, $ans, $othertext, $badgeid, $privacyuser, $ans, $othertext, $badgeid);
                    }
                    //echo "<br />shortname = '" . $obj->shortname . "'";
                    //echo "<pre>"; var_dump($parms); echo "</pre>";
