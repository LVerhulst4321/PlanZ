<?php
$report = [];
$report['name'] = 'Published Filk Grid';
$report['description'] = 'Display schedule of rooms with any published filk events. (Division = 13) This excludes any item marked "Do Not Print". ';
