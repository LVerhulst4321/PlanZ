<?php
$report = [];
$report['name'] = 'CSV -- Panel Report for Pubs 2';
$report['description'] = 'Export CSV file of full public schedule for publications. Uses special participant label field.';
