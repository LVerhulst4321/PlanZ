...
$report = [];
$report['name'] = 'Unabridged Programming Grid - Events Only';
$report['multi'] = 'true';
$report['output_filename'] = 'unabridged_event_grid.csv';
$report['description'] = 'Display entire event schedule with rooms on horizontal axis and time on vertical. This includes all items marked "Do Not Print". ';
$report['categories'] = array(
    'Programming Reports' => 225,
    'Grid Reports' => 225,
);
$report['queries'] = [];
