<?php
$report = [];
$report['name'] = 'Film Sessions by Time ';
$report['multi'] = 'true';
$report['output_filename'] = 'filmroom.csv';
$report['description'] = 'Just things in the Film rooms';
...
SELECT
    ...
    WHERE
        R.function like '%Film%'
        AND S.divisionid = 7 # Film
    ORDER BY
        SCH.starttime;
EOD;
$report['xsl'] =<<<'EOD'
