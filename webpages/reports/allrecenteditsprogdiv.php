...
$report = [];
$report['name'] = 'All Recent Edits -- Program Div';
$report['description'] = 'All edits to sessions, session participants or the schedule made within the Program division within the past 10 days.';
$report['categories'] = array(
    'Programming Reports' => 75,
);
$report['queries'] = [];
...
SELECT
        SEH.timestamp,
        DATE_FORMAT(SEH.timestamp, "%c/%e/%y %l:%i %p") AS formattedts,
        DATEDIFF(NOW(), SEH.timestamp) AS days,
        sessionid,
        badgeid
    FROM
