...
$report = [];
$report['name'] = 'Room Turns 2';
$report['description'] = 'List of all Sessions related to room turns (Sorted by time, then room)';
...
SELECT
    ...
    WHERE
        S.typeid IN (3, 21, 22) # Room Turn, Setup, Refresh
        OR S.trackid=14 # roomturn
    ORDER BY
...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <xsl:choose>
            <xsl:when test="doc/query[@queryName='report']/row">
                <table class="report">
                    <tr>
