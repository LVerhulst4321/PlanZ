...
$report['description'] = 'Shows all participant information retrieved from the registration system';
...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
                ...
                <table id="reportTable" class="table table-sm table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th rowspan="2" valign="top" style="padding-top:0.7rem">Person Id</th>
                            <th rowspan="2" valign="top" style="padding-top:0.7rem">Reg Type</th>
                            <th rowspan="2">Badge Number</th>
                            ...
                            <th rowspan="2" valign="top" style="padding-top:0.7rem">LastRegUpdate</th>
    ...
    <xsl:template match="doc/query[@queryName='participants']/row">
        <tr>
            ...
            <td><xsl:value-of select="@last_reg_update" /></td>
