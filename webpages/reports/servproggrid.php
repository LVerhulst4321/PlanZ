...
$report = [];
$report['name'] = 'Program Services Grid';
$report['multi'] = 'true';
$report['output_filename'] = 'servproggrid.csv';
$report['description'] = 'Show Service Requests on a grid for Program equipment only. ';
