...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
            ...
            <xsl:when test="doc/query[@queryName='sessions']/row">
                <table class="report">
                    <tr>
                        ...
                        <th class="report">StartDay</th>
                        <th class="report">StartTime</th>
                        <th class="report">Duration</th>
                        <th class="report">EndDay</th>
                        <th class="report">EndTime</th>
    ...
    <xsl:template match="doc/query[@queryName='sessions']/row">
        <tr>
            ...
            <td class="report"><xsl:value-of select="@endday" /></td>
            <td class="report"><xsl:value-of select="@endtm" /></td>
