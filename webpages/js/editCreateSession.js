...
function initializeSessionEdit() {
    ...
    tinyMCE.init({
        ...
        plugins: 'table wordcount fullscreen advlist link preview searchreplace autolink charmap hr nonbreaking visualchars code ',
        paste_as_text: true,
        ...
        menubar: false,
        toolbar: [
            'undo redo | bold italic underline strikethrough removeformat | visualchars nonbreaking charmap hr | forecolor backcolor | preview fullscreen ',
            'searchreplace | alignleft aligncenter alignright alignjustify | outdent indent | link code'
        ],
        toolbar_mode: 'wrap',
