...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        ...
        <xsl:variable name="editAgeRanges"
            select="/doc/query[@queryname='permission_set']/row[@permatomtag='ce_AgeRanges' or @permatomtag='ce_All']" />
        ...
        <xsl:variable name="editServiceTypes"
        ...
        <xsl:variable name="editAnyEmail"
            select="$editEmailFrom or $editEmailTo or $editEmailCC" />
        ...
        <xsl:variable name="editLocations"
        ...
        <xsl:variable name="editAnyThing"
            select="$editAnyParticipant or $editAnySession or $editAnyFacility or $editAnyEmail or $editAnyMisc" />
                    ...
                    <div class="tab-pane fade show mt-4 active" id="overview">
                        ...
                        <p>
                            ...
                            <ul>
                                ...
                                <xsl:if test="$editAnyEmail">
                                    <li>Emails: Tables that define PlanZ's ability to send emails to participants</li>
                                </xsl:if>
                                <xsl:if test="$editAnyMisc">
                                    <li>Miscellaneous: Tables not otherwise categorized</li>
                                </xsl:if>
                            </ul>
                        </p>
                    ...
                    <xsl:if test="$editAnyParticipant">
                        <div class="tab-pane fade show mt-4" id="part">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <xsl:if test="$editInterests">
                                    <li class="nav-item">
                                        <a href="#interests" class="nav-link" data-toggle="tab" data-top="part-top"
                                           id="t-Interests">Interests
                                        </a>
                                    </li>
                                </xsl:if>
                                <xsl:if test="$editAgeRanges">
                                    <li class="nav-item">
                                        <a href="#ageranges" class="nav-link" data-toggle="tab" data-top="part-top"
                                           id="t-AgeRanges">Age Ranges
                                        </a>
                                    </li>
                                </xsl:if>
                                <xsl:if test="$editPronouns">
                                    <li class="nav-item">
                                        <a href="#pronouns" class="nav-link" data-toggle="tab" data-top="part-top"
                                           id="t-Pronouns">Pronouns
                                        </a>
                                    </li>
                                </xsl:if>
                    ...
                    <xsl:if test="$editAnyFacility">
                        <div class="tab-pane mt-4 fade" id="facility">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <xsl:if test="$editServiceTypes">
                                    <li class="nav-item">
                                        <a href="#servicetypes" class="nav-link" data-toggle="tab" data-top="facility-top"
                                           id="t-ServiceTypes">ServiceTypes
                                        </a>
                                    </li>
                                </xsl:if>
                                <xsl:if test="$editLocations">
                                    <li class="nav-item">
                                        <a href="#locations" class="nav-link" data-toggle="tab" data-top="facility-top"
                                           id="t-Locations">Locations
                                        </a>
                                    </li>
                                </xsl:if>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane mt-4 fade show active" id="emaildesc">
                                    ...
                                    <ul>
                                        <xsl:if test="$editEmailFrom">
                                            <li>EmailFrom</li>
                                            <p>List of From: lines for emails sent by PlanZ</p>
                                        </xsl:if>
                                        <xsl:if test="$editEmailTo">
                                            <li>EmailTo</li>
                                            <p>List of queries to select emails to be sent by PlanZ</p>
                                        </xsl:if>
                                        <xsl:if test="$editEmailCC">
                                            <li>EmailCC</li>
                                            <p>List of potential CC address choices for emails sent by PlanZ</p>
                                        </xsl:if>
                                    </ul>
                                </div>
                                <xsl:if test="$editEmailFrom">
