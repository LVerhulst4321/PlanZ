 ...
 * 
 * PlanZ allows staff users to search Session data from prior cons to
 ...
 *  TrackCompatibility.
 * 
 * Later notes indicated that PreviousParticipants should contain last year's participants (only).
...
$lastDBname = "hosting_planz_{$lastYear}";
$thisDBname = "hosting_planz_{$thisYear}";
if ($test) {
    $thisDBname .= '_test';
