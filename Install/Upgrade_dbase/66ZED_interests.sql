...
VALUES ('2050', 'ce_Interests', 'Edit Configuration Tables', 'enables edit');
...
WHERE permatomtag IN  ('ce_Interests');


INSERT INTO PatchLog (patchname) VALUES ('66ZED_interests.sql');
