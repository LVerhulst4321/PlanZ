...
## Add day 4 open and close times
## Add day 5 open and close times
...
ALTER TABLE `Rooms` ADD COLUMN `opentime5` time DEFAULT NULL AFTER `closetime4`;
ALTER TABLE `Rooms` ADD COLUMN `closetime5` time DEFAULT NULL AFTER `opentime5`;
...
VALUES ('2053', 'ce_RoomColors', 'Edit Configuration Tables', 'enables edit');
...
WHERE permatomtag IN  ('ce_RoomColors');


INSERT INTO PatchLog (patchname) VALUES ('68ZED_color_room_grid.sql');
